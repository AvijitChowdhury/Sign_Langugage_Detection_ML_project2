...
class Application:
    ...
    def __init__(self):
        ...
        self.bt4=tk.Button(
            self.root,command=self.action6,height=5,width=10,text="Erase",foreground='black',background='pink'
        )
        self.bt4.place(x=725, y=745)
        self.bt5=tk.Button(
            self.root,command=self.action7,height=5,width=10,text="Close",background='red'
        )
